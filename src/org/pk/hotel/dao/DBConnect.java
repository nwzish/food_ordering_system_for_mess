...
//			}
		...
		String SQL = "select qnt from item where id='" + itemId + "'";
	...
	public boolean updateItemCount(int itemId, int quantity) {
		String SQL = "UPDATE item SET qnt='" + quantity
				+ "' where id='" + itemId +  "'";
...
//					bd.setOrderName(rs.getString("order_master.name"));
//					bd.setItemName(rs.getString("item.name"));
//					int quantity = rs.getInt("item.qnt");
//					bd.setItemQnt(quantity);
//					int price = rs.getString("item.cost");
//					bd.setOrderQnt(rs.getInt("order_details.qnt"));
//					bd.setItemCost();
//					bdetails.add(bd);
